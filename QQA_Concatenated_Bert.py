...
# --- Dataset ---
class QQAConcatDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question_sci = item["question_sci_10E"].strip()
        ...
        input_text = (
            f"Q: {question} [SEP] Sci: {question_sci} "
            f"[SEP] Option 1: {option1} [SEP] Option 2: {option2}"
        )
...
train_dataset = QQAConcatDataset("QQA/QQA_train.json", tokenizer)
dev_dataset = QQAConcatDataset("QQA/QQA_dev.json", tokenizer)
...
test_dataset = QQATestOnlyDataset(raw_test_data, tokenizer)
